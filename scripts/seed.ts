 ...
 */
const thumb = (id: string, res: "max" | "hq" | "mq" = "max") =>
...
const CHANNEL = "https://www.youtube.com/@rogerraker";
const AVATAR =
...
async function main() {
  ...
  try {
    ...
    await client.query(
      ...
      [
        "Roger Raker",
        "Hi, ako nga pala si Roger. I've been making short films and vlogs on YouTube since 2010. It started with a camera, a laptop, and a group of friends. The channel is at 1.52 million subscribers now, and this is where I hand over the tools I use.",
        AVATAR,
        JSON.stringify({
          youtube: CHANNEL,
        ...
        "Filmmaker and vlogger, short films since 2010",
